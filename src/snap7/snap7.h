...
public:
    ...
    static int S7_get_int_from_buffer(byte Buffer[], int Pos);
    static int S7_get_dint_from_buffer(byte Buffer[], int Pos);
    static uint16_t S7_get_word_from_buffer(byte Buffer[], int Pos);
    static uint8_t S7_get_byte_from_buffer(byte Buffer[], int Pos);
    static double S7_get_real_from_buffer(byte Buffer[], int Pos);
    static uint32_t S7_get_dword_from_buffer(byte Buffer[], int Pos);
    static bool S7_get_bool_from_buffer(byte Buffer[], int Pos, int bit);
    static void S7_make_real_to_buffer(byte Buffer[], int Pos, float Value);
    static void S7_make_int_to_buffer(byte Buffer[], int Pos, int16_t Value);
    static void S7_make_dint_to_buffer(byte Buffer[], int Pos, int32_t Value);
    static void S7_make_word_to_buffer(byte Buffer[], int Pos, uint16_t Value);
    static void S7_make_dword_to_buffer(byte Buffer[], int Pos, uint32_t Value);
    // Control functions
    int Connect();
